...
cc200_ws8_bs = {
    ...
    # "fringeCoeff" : 0.0, # fringeSize = fringeCoeff * (windowSize) * 2 * (1-shiftCoeff)
    "fringeCoeff" : 0.5, # fringeSize = fringeCoeff * (windowSize) * 2 * (1-shiftCoeff)
    "focalRule" : "fixed",
    ...
    'num_cluster': 8,
    'kmeans_loss_weight': 2e-2,
    'inter_subs_loss_weight': 0.2,
    'intra_sub_loss_weight': 1,  

    'update_ep_points': [7, 12, 17, 22, 27, 32],

    'cache_dir_base': 'cache/bolt/tmp/kmeans002_inter02_cluster8_softmax2_relu_tr2_test', 
